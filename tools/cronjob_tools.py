...
def cronjob(
    ...
    try:
        ...
        if normalized == "create":
            ...
            if routing_warning:
                # Fork: append to upstream's gateway-liveness warning, never replace it.
                _result["warning"] = (
                    f"{_result['warning']} {routing_warning}" if _result.get("warning") else routing_warning
                )
        ...
        if normalized == "update":
            ...
            if routing_warning:
                # Fork: append to upstream's gateway-liveness warning, never replace it.
                _upd_result["warning"] = (
                    f"{_upd_result['warning']} {routing_warning}" if _upd_result.get("warning") else routing_warning
                )
