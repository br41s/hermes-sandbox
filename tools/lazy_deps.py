...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "platform.discord": (
        ...
        "aiohttp==3.14.3",  # CVE-2026-69244/59881/69243 + 34513/34518/34519/34520/34525 + 34993(RCE)/47265
    ),
    "platform.slack": (
        "slack-bolt==1.29.0",
        "slack-sdk==3.43.0",
    ...
    "platform.teams": ("microsoft-teams-apps==2.0.13.4", "aiohttp==3.14.3"),  # aiohttp 3.14.3: CVE-2026-69244/59881/69243 + 34993(RCE)/47265 + 34513/34518/34519/34520/34525
    ...
    "tool.dashboard": (
        ...
        "python-multipart==0.0.31",  # CVE-2026-53539 quadratic form-parse DoS + 53537/53538/53540; FastAPI UploadFile/Form (NS-501)
    ),
    ...
    "tool.computer_use": (
        "mcp==1.28.1",  # CVE-2026-52869/52870/59950 (server transports; stdio-only here)
