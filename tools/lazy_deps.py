...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    # No API key — plugins/web/ddgs/provider.py calls ensure() at its own
    # SDK-import chokepoint, same as the three above. Was previously wired
    # to nothing, so an explicit web.search_backend: ddgs config selected a
    # provider that could never actually install itself (#174).
    ...
    "platform.discord": (
        ...
        "aiohttp==3.14.3",  # CVE-2026-69244/59881/69243 (GHSA-cq5v-8q36-5273/GHSA-mfx4-hv73-q22v/GHSA-mq44-7p77-q5h7) + 34513/34518/34519/34520/34525 + 34993(RCE)/47265
    ),
    "platform.slack": (
        "slack-bolt==1.30.0",
        "slack-sdk==3.43.0",
    ...
    "platform.teams": ("microsoft-teams-apps==2.0.13.4", "aiohttp==3.14.3"),  # aiohttp 3.14.3: CVE-2026-69244/59881/69243 (GHSA-cq5v-8q36-5273/GHSA-mfx4-hv73-q22v/GHSA-mq44-7p77-q5h7) + 34993(RCE)/47265 + 34513/34518/34519/34520/34525
    ...
    "tool.dashboard": (
        ...
        "python-multipart==0.0.32",  # >=0.0.31: CVE-2026-53539 quadratic form-parse DoS + 53537/53538/53540; FastAPI UploadFile/Form (NS-501)
    ),
    ...
    "tool.vision": ("Pillow==12.3.0",),  # CVE-2026-59197/59199/59205 heap OOB writes + decompression bombs
