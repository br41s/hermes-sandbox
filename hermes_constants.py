...
def is_container() -> bool:
    ...
    Kubernetes/k3s) were previously missed. To cover those, also check:
      ...
      * ``/run/secrets/kubernetes.io/serviceaccount`` (explicit K8s probe).
    ...
    if os.environ.get("KUBERNETES_SERVICE_HOST"):
        _container_detected = True
        return True
    # Belt-and-braces for the Zeabur K8s orphan-gateway fix (our PR #23):
    # keep the explicit serviceaccount-path probe alongside the env check.
