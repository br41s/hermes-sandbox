...
def _run_job_impl(
    ...
    # Run the agent in an ephemeral clone of a git workdir; fail closed if it
    # cannot be provisioned. See cron/fork_ext/isolated_checkout.py.
            ...
            if _cron_inactivity_limit is None:
                ...
                while True:
                    ...
                    if _idle_secs >= _cron_inactivity_limit:
                        _dump_stuck_agent_stack(job_id, _idle_secs)
                        _note_abandoned_agent_thread()
